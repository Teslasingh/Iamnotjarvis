...
class OllamaLLM(LLM):
    ...
    #api_url: str = "http://10.8.0.3:11434/api/generate"  # llama3.2
    api_url: str = "http://34.87.121.182:5055/api/generate"
    max_tokens: int = 500
...
class CodeGenerationSystem:
    ...
    def run(self, user_prompt: str) -> None:
        ...
        historical_context = self._create_context_from_history(recent_histories, user_prompt)
